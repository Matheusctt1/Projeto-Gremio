...
def filtrarDataFrame(infoJogo, infoColetivo, listaAtletas, listaGoleiros, df, listaPosicoes):
    ...
    time.sleep(2)
    cadastrarAcoes.realizarCadastros(infoJogo, infoColetivo, listaAtletas, listaGoleiros, listaPosicoes,  passeCertoTempoEmJogo, passeCertoTempoEmJogoGo, tipoAcao, tipoAcaoGo, X, Y)
