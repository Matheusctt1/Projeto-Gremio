...
def cadastroBancoIndividual(infoJogo, infoColetivo, atleta, posicao, acoes, passeCertoTempoEmJogo, MCDTotal, MCOTotal, intercepTotal):
    ...
    listaDeAcoes = ['GOL', 'FINALIZAÇÃO NO GOL', 'FINALIZAÇÃO PRA FORA', 'FINALIZAÇÃO BLOQUEADA', 
                ...
                'INTERCEPTAÇÃO', 'DESARME CERTO', 'DRIBLE SOFRIDO', 'DRIBLE CERTO','PERDA DA BOLA',
                'PASSE ERRADO', 'PASSE VERTICAL', 'PASSE VERTICAL ERRADO', 'PASSE LONGO', 'PASSE LONGO ERRADO',
                'CRUZAMENTO', 'CRUZAMENTO ERRADO', 'VITÓRIA JOGO AÉREO', 'DERROTA JOGO AÉREO',
    ...
    for tipoAcao in acoes:
        ...
        if (tipoAcao == listaDeAcoes[17]):
            passeLongoErra += 1  
            #TotalPasseLongoErrado = passeLongoErra + TotalPasseLongoErrado
        ...
        #TotalPasseCerto = passeCertoTempoEmJogo[0] + TotalPasseCerto
    ...
    nota.calcularNotas(adversarioData, nivelJogo, dataJogo, campeonato, categoria, referencia, tempoTotalJogo, nomeAtleta, posicao, gol, finaGol,
                    ...
                    perdaBola, passeCertoTempoEmJogo[0], passeErrado, passeVertical, passeVerticalErrado, passeLongo, passeLongoErra, cruzamento, 
                    cruzamentoErrado, vitoriaAereo, derrotaAereo, MCD, MCO, passeCertoTempoEmJogo[1], MCDTotal, MCOTotal, intercepTotal)
