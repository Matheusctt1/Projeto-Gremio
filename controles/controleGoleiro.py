...
def cadastrarGoleiro(goleiro):
    ...
    INSERT INTO BD_GOLEIROS ([Adversario+data],[Nivel de jogo],[Data],[Campeonato],[Categoria],[Referencia],[Tempo de jogo]
                            ...
                            ,[Defesa sem rebote],[Falha],[Gol sofrido],[Passes certos],[Reposição rapida],[Reposição curta certa],[Reposição curta errada]
    ...
    goleiro.falha, goleiro.golSofrido, goleiro.passesCertos, goleiro.reposicaoRapida, goleiro.reposicaoCurtaCerta, goleiro.reposicaoCurtaErrada, goleiro.reposicaoMediaCerta, 
